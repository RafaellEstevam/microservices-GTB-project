...
public class ItemAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 189717108305794026L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ItemAvro\",\"namespace\":\"com.project.msorder.config.avro\",\"fields\":[{\"name\":\"product\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":\"float\"}]}");
   ...
   */
  public static com.project.msorder.config.avro.ItemAvro.Builder newBuilder() {
    return new com.project.msorder.config.avro.ItemAvro.Builder();
  }
   ...
   * @return A new ItemAvro RecordBuilder
   */
  public static com.project.msorder.config.avro.ItemAvro.Builder newBuilder(com.project.msorder.config.avro.ItemAvro.Builder other) {
    if (other == null) {
      return new com.project.msorder.config.avro.ItemAvro.Builder();
    } else {
      return new com.project.msorder.config.avro.ItemAvro.Builder(other);
    }
  }
   ...
   * @return A new ItemAvro RecordBuilder
   */
  public static com.project.msorder.config.avro.ItemAvro.Builder newBuilder(com.project.msorder.config.avro.ItemAvro other) {
    if (other == null) {
      return new com.project.msorder.config.avro.ItemAvro.Builder();
    } else {
      return new com.project.msorder.config.avro.ItemAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ItemAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.project.msorder.config.avro.ItemAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.project.msorder.config.avro.ItemAvro other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.product)) {
        this.product = data().deepCopy(fields()[0].schema(), other.product);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.project.msorder.config.avro.ItemAvro.Builder setProduct(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.project.msorder.config.avro.ItemAvro.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.project.msorder.config.avro.ItemAvro.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.project.msorder.config.avro.ItemAvro.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.project.msorder.config.avro.ItemAvro.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.project.msorder.config.avro.ItemAvro.Builder clearPrice() {
