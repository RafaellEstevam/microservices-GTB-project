...
public class ItemAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5021019998758315536L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ItemAvro\",\"namespace\":\"com.GTB.msordereventsconsumer.config.avro\",\"fields\":[{\"name\":\"product\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"price\",\"type\":\"float\"}]}");
   ...
   */
  public ItemAvro(java.lang.String product, java.lang.Integer quantity, java.lang.Float price) {
   ...
   */
  public static com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder newBuilder() {
    return new com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder();
  }
   ...
   * @return A new ItemAvro RecordBuilder
   */
  public static com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder newBuilder(com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder other) {
    if (other == null) {
      return new com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder();
    } else {
      return new com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder(other);
    }
  }
   ...
   * @return A new ItemAvro RecordBuilder
   */
  public static com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder newBuilder(com.GTB.msordereventsconsumer.config.avro.ItemAvro other) {
    if (other == null) {
      return new com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder();
    } else {
      return new com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ItemAvro>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.GTB.msordereventsconsumer.config.avro.ItemAvro other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.product)) {
        this.product = data().deepCopy(fields()[0].schema(), other.product);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder setProduct(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.GTB.msordereventsconsumer.config.avro.ItemAvro.Builder clearPrice() {
